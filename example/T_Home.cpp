    ...
    : ElaScrollPage(parent)
{
    ...
    backgroundCard->setCardImage(QImage(":/src/Image/Home_Background.png"));
    ...
    homeCard1->setCardPixmap(QPixmap(":/src/Image/control/AutomationProperties.png"));
    ...
    homeCard2->setCardPixmap(QPixmap(":/src/Image/control/BreadcrumbBar.png"));
    ...
    homeCard3->setCardPixmap(QPixmap(":/src/Image/control/StandardUICommand.png"));
    ...
    homeCard4->setCardPixmap(QPixmap(":/src/Image/control/MenuFlyout.png"));
    ...
    homeCard5->setCardPixmap(QPixmap(":/src/Image/control/Canvas.png"));
    ...
    urlCard2->setCardPixmap(QPixmap(":/src/Image/Moon.jpg"));
