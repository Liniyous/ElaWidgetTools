    ...
    : ElaScrollPage(parent)
{
    ...
    backgroundCard->setCardImage(QImage(":/Image/Home_Background.png"));
    ...
    homeCard1->setCardPixmap(QPixmap(":/Image/control/AutomationProperties.png"));
    ...
    homeCard2->setCardPixmap(QPixmap(":/Image/control/BreadcrumbBar.png"));
    ...
    homeCard3->setCardPixmap(QPixmap(":/Image/control/StandardUICommand.png"));
    ...
    homeCard4->setCardPixmap(QPixmap(":/Image/control/MenuFlyout.png"));
    ...
    homeCard5->setCardPixmap(QPixmap(":/Image/control/Canvas.png"));
    ...
    urlCard1->setCardPixmap(QPixmap(":/Image/github.png"));
    ...
    urlCard2->setCardPixmap(QPixmap(":/Image/Moon.jpg"));
